...
mod tests {
    ...
    use crate::worker::runtime::{WorkerConfig, WorkerRuntime, truncate};
    ...
    #[tokio::test]
    async fn test_worker_runtime_build_tools_includes_extension_meta_tools() {
    ...
    #[tokio::test]
    async fn test_worker_runtime_new_advertises_meta_tools() {
        let client = Arc::new(WorkerHttpClient::new(
            "http://localhost:50051".to_string(),
            Uuid::nil(),
            "test".to_string(),
